...
class FetchAllReleases(Vertical):
    ...
    def reset(self) -> None:
        self.query_one('#fetch-all-releases-counter', Label).update('Releases fetched: 0')
    ...
    def add_release(self, release_title: str, nb_tracks: int) -> None:
        ...
        self.query_one('#fetch-all-releases-counter', Label).update(f'Releases fetched: {log.line_count}')
