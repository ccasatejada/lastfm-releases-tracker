...
from lastfm_release_tracker.model.model import AppUserRelease, Artist, Release
from lastfm_release_tracker.utils.date_utils import compute_length, format_date
...
class ReleaseDetailSection(Vertical):
    ...
    async def show_release(
        ...
        cover_path = releases_thumbnails_dir(release.id_artist) / f'{release.id}.jpg'
        try:
